...
from database import create_db, user_in_database, add_data_to_users, get_user_id, hozirgi_userni_olish, add_data_to_category, get_all_categories, get_category_id, delete_category_by_id,get_all_products, add_data_to_product, get_c_id_by_name, get_product_by_id, add_data_user_product, add_data_to_cart, get_user_product, delete_product_by_id
